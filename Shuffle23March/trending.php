<?php session_start(); ?> <?php include( 'dbconnect.inc.php' ); $pageTitle = "|  Trending Feeds"; $user_id = $_SESSION["user_id"]; ?>
<!DOCTYPE HTML>
	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<div id="loading">
					<center><img src="images/loading.gif" id="loading"/>
						<h2>This may take a some time while we check our stats, our users have been very active!</h2>
					</center>
				</div>
			</div>
		</div>
