...
//https://api.jquery.com/jQuery.parseXML/
		...
		$(document).ready(function() {
			...
			$.ajax({
				...
				dataType: "jsonp",
				jsonp: "callback",
				url: "https://shuffle.twistednetworkmedia.uk/mng_feed.php?rssid=" + rssId,
			...
			//UPDATE COMMENTS - SEND -------------------------------------------------------
				...
				$.ajax({
					...
					dataType: "jsonp",
					jsonp: "callback",
					url: "https://shuffle.twistednetworkmedia.uk/mng_comment.php?" + ajaxString,
					success: function(data) {
			...
			$(document).on("click", '.deletecom', function(event) { 
				...
				$.ajax({
					...
					dataType: "jsonp",
					jsonp: "callback",
					url: "https://twistednetworkmedia.uk/mng_comment.php?action=delete&comment_id=" + $(this).attr('comid'),
					success: function(data) {
